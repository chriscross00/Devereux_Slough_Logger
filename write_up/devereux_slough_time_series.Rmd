...
This breaks down the data into it's individual components: seasonality, trend and the residuals. The seasonality seems to be daily and the trend is a gradual downward slope.
...
ACF and PACF before differencing. There is a obvious pattern to our data and most of the lags are above the significance level.
```{r}
